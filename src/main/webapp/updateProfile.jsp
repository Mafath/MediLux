...
<div class="bg-white bg-opacity-60 backdrop-blur-md border border-gray-200 shadow-2xl rounded-2xl p-8 w-full max-w-4xl">
    <h2 class="text-2xl font-semibold text-gray-800 mb-8 text-center">Update Profile</h2>
    ...
    <form action="UpdateProfileServlet" method="post">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="<%= (name != null && !name.isEmpty()) ? name : "" %>" required
            ...
            <div>
                ...
                <input type="email" id="gmail" name="gmail" value="<%= (gmail != null && !gmail.isEmpty()) ? gmail : "" %>" required
                       class="w-full px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 focus:ring-2 focus:ring-teal-400">
            </div>
       ...
       >
        ...
        <div class="text-center pt-8">
            <a href="GetUserProfileServlet" class="text-teal-600 underline mr-6">Cancel</a>
